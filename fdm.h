...
class FDMBase {
	protected:
		...
		//Storage
		vector<double> new_result;	//New solution (becomes N+1)
		vector<double> old_result;	//Old solution (becomes N)
		...
		//Override these virual methods in derived classes for
